$(function(){        
    ...
    var rdc = new Rickshaw.Graph( {
            ...
            series: [{color: "#33414E",data: seriesData[0],name: 'New'}, 
                     ...
                     {color: "#F90",data: seriesData[2],name: '123'}]
    } );
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Kho Ban tác nghiệp", value: 1113},
            {label: "Kho Ban đầu tư", value: 764},
            {label: "Kho lưu ký", value: 328},
            {label: "Kho lưu ký sàn Hà Nội", value: 643},
            {label: "Kho lưu ký sàn HCM", value: 513},
            {label: "Kho cầm cố thế chấp", value: 738}
        ],
        colors: ['#33414E', '#3FBAE4', '#FEA223','#8e3d05','#45c400','#dc4266'],
        resize: true
    });
    ...
    Morris.Bar({
        ...
        data: [
            { y: 'Sổ đỏ', a: 120, b: 45, c:75 },
            { y: 'Cổ phiếu/Trái phiếu', a: 88, b: 22, c:44 },
            { y: 'Séc/UNC', a: 23, b: 50, c:27 },
            { y: 'Khác', a: 123, b: 150, c:27 },
        ],
        xkey: 'y',
        ykeys: ['a', 'b', 'c'],
        labels: ['Mua', 'Bán','Lãi/Lỗ'],
        barColors: ['#33414E', '#3FBAE4','#F90'],
        gridTextSize: '10px',
        hideHover: true,
        resize: true,
