<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Admin/Instructions/Instructions.master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="SM.eTemplate.UI.Admin.Instructions.Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-sm-10">
				<p class="form-control-static"><%= ParentInstruction == null ? "" : ParentInstruction.Name %></p>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<asp:DropDownList CssClass="form-control" 
					ID="_screensDropDownList" runat="server"></asp:DropDownList>
			</div>
		</div>
